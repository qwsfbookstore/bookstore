...
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		echo '<div class="product_storyList_content_right">
                <ul>
                    <li class="product_storyList_content_dash"><a href="#" class="blue_14">'.$row["book_name"].'</a></li>
                    <li>顾客评分：'.$row["book_grade"].'</li>
                    <li>作　者：<a href="#" class="blue_14">'.$row["author_name"].'</a> 著</li>
                    <li>出版社：<a href="#" class="blue_14">'.$row["book_publisher"].'</a></li>
                    <li>'.$row["CH_intro"].'</li>
                    <li>
